...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-end bg-dark bg-opacity-50 px-4 py-2 rounded-pill border border-gold border-opacity-25 shadow-sm">
    ...
    <?php if ($success_msg): ?>
        <div class="alert bg-success bg-opacity-25 text-success border border-success border-opacity-25 alert-dismissible fade show rounded-3" role="alert">
    ...
    <?php if ($error_msg): ?>
        <div class="alert bg-danger bg-opacity-25 text-danger border border-danger border-opacity-25 alert-dismissible fade show rounded-3" role="alert">
                    ...
                    <table class="table table-dark table-hover align-middle bg-transparent mb-0">
                        <thead class="text-white-50 small text-uppercase">
                            <tr>
                                ...
                                <th class="bg-transparent border-bottom border-light border-opacity-10 py-3">Category</th>
                                ...
                                <?php foreach ($expenses as $exp): ?>
                                    <tr>
                                        ...
                                        <td class="bg-transparent border-light border-opacity-10">
                                            ...
                                            <div class="small text-white-50">Added by <?php echo htmlspecialchars($exp['full_name']); ?></div>
                                        </td>
                                        <td class="bg-transparent border-light border-opacity-10">
                                            <span class="badge bg-dark border border-secondary border-opacity-50 text-white-50 rounded-pill px-3 py-2">
