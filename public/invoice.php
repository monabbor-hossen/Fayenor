...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .divider {
            height: 1px;
            background: linear-gradient(to right, #d8eadc, #e0e8e2, #d8eadc);
            margin: 0 0 34px;
        }
        ...
        @media print {
            @page {
                size: A4 portrait;
                margin: 0;
                /* ← removes browser URL / date / page-number footer */
            }
            ...
            /* Make the invoice card fill the full A4 page height,
               then use flex-column so the body stretches and
               the footer is always pinned to the bottom */
            .invoice {
                box-shadow: none;
                border-radius: 0;
                display: flex;
            ...
            /* flex-grow:1 makes the body fill all remaining space */
            .invoice-body {
                padding: 15px 34px;
                flex: 1;
            }

            /* Footer is always pushed to the very bottom */
            .invoice-footer {
                padding: 15px 34px;
                margin-top: auto;
            }
